...
* <a id="python"> **Python** - Python NLP Libraries</a> | [Back to Top](#contents)
  ...
  - [FoJin](https://github.com/xr843/fojin) - Open-source Buddhist text platform with multi-language search (30 languages), ICU tokenization, pgvector semantic search, and RAG-based Q&A over 11M characters of classical texts.
