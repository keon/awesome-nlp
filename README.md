...
- [ProseScore](https://prosescore.ckmtools.dev) - Free browser-based readability analyzer with 8 formulas (Flesch-Kincaid, Gunning Fog, SMOG, etc.), sentiment analysis, and keyword extraction
