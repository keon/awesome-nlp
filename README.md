...
- [VeroQ](https://github.com/veroq-ai/shield) - Verify any LLM output in one function call. Extract claims, fact-check against live evidence, get trust scores and corrections.
