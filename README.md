...
- [Shimmy](https://github.com/Michael-A-Kuykendall/shimmy) - Self-hosted NLP inference server with OpenAI API compatibility for text generation and conversational AI.
