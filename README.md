...
- [BGPT MCP](https://github.com/connerlambden/bgpt-mcp) - Remote MCP server for searching scientific papers with structured experimental data extracted from full-text studies
